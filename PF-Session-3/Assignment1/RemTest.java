...
public class RemTest {
	...
	/*failure test case for finding remainder when first number is negaitve*/
	...
	/*failure test case for finding remainder when second number is 0*/
	@Test(expected = ArithmeticException.class)
	...
	/*failure test case for finding remainder when second number is negative*/
	@Test(expected = ArithmeticException.class)
