...
public class TowerOfHanoiTest {
	...
	/**
	 * failure test case for checking arithmetic exception when number of disk is 0
	 */
	@Test(expected = ArithmeticException.class)
	public void testTowerOfHanoiWhenDiskZero() throws ArithmeticException {
		int n = 0;
	...
	/**
	 * failure test case for checking arithmetic exception when number of disk is in negative
	 */
	@Test(expected = ArithmeticException.class)
	public void testTowerOfHanoiWhenDiskNegative() throws ArithmeticException {
		int n = -2;
		List<String> expected=Arrays.asList("");
		assertEquals(expected, towerOfHanoi.towerOfHanoi(n, 'A', 'C', 'B'));
	}
